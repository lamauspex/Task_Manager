...
class TaskBase(CreateBase):
    ...
    description: Optional[str] = Field(
        max_length=300, description="Описание задачи")
...
class TaskUpdate(UpdateBase):
    ...
    description: Optional[str] = Field(
        None, max_length=300, description="Название задачи")
    title: Optional[str] = Field(max_length=100, description="Описание задачи")
    status: Optional[TaskStatus] = Field(description="Новый статус задачи")
